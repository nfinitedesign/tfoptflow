...
def _main():
    ...
    nn_opts = {
        ...
        'val_batch_size': 128,  # Use -1 to use entire validation split, or set number of val samples (0 disables it)
        ...
        'max_steps': 50000,  # max number of training iterations (i.e., batches to run)
        'lr_boundaries': [5000, 10000, 15000, 25000],  # step schedule boundaries
        'lr_values': [1e-04, 5e-05, 1e-05, 5e-06, 1e-06],  # step schedule values
        # Cyclic lr schedule
